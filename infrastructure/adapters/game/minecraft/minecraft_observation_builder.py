...
class MinecraftObservationBuilder(ObservationBuilderPort):
    ...
    def build(self, *, events: List[List[dict]]) -> Observation:
        print(f"MinecraftObservationBuilder: events: {events}")
        error_messages = []
        chat_messages = []
        ...
        chests_dict = {k: v for k, v in chests_dict.items() if v != "Invalid"}
...
if __name__ == "__main__":
    ...
    # to make it clean event formatting
    sample_events = [
        [
            "onChat",
            {
                "onChat": "Explore success.",
                "voxels": ["dirt", "grass_block", "grass", "tall_grass", "sand"],
                "status": {
                    "health": 15.499998092651367,
                    "food": 14,
                    "saturation": 0,
                    "oxygen": 20,
                    "position": {"x": 12.484598755708154, "y": 65, "z": 103.5},
                    "velocity": {"x": 0, "y": -0.0784000015258789, "z": 0},
                    "yaw": -3.0944688436804477,
                    "pitch": -6.6579310953329696e-09,
                    "onGround": True,
                    "equipment": [None, None, None, None, "beef", None],
                    "name": "bot",
                    "isInWater": False,
                    "isInLava": False,
                    ...
                    "biome": "plains",
                    "entities": {
                        "squid": 12.692193555553986,
                        "salmon": 24.628961959274285
                    },
                    "timeOfDay": "day",
                    "inventoryUsed": 3,
                    "elapsedTime": 5
                ...
                "blockRecords": ["dirt", "grass_block", "grass", "tall_grass", "sand"]
            }
        ],
        [
            "onError",
            {
                "onError": "Evaluation error: Runtime error: Took to long to decide path to goal!",
                "voxels": ["dirt", "grass_block", "water", "grass", "tall_grass", "tall_seagrass", "seagrass", "sand"],
                "status": {
                    "health": 15.499998092651367,
                    "food": 13,
                    "saturation": 0,
                    "oxygen": 20,
                    "position": {"x": 11.5, "y": 64, "z": 105.58307312183041},
                    "velocity": {"x": 0, "y": -0.0784000015258789, "z": 0},
                    "yaw": -1.691224125077094,
                    "pitch": -6.6579310953329696e-09,
                    "onGround": True,
                    "equipment": [None, None, None, None, "beef", None],
                    "name": "bot",
                    ...
                    "biome": "plains",
                    "entities": {
                        "squid": 12.09025123758174,
                        "salmon": 18.625828873977103
                    },
                    "timeOfDay": "day",
                    "inventoryUsed": 3,
                    "elapsedTime": 131
                ...
                "nearbyChests": {},
                "blockRecords": ["dirt", "grass_block", "grass", "tall_grass", "sand", "water", "tall_seagrass", "seagrass"]
            }
        ],
        [
            "observe",
            {
                ...
                "status": {
                    ...
                    "biome": "plains",
                    "entities": {
                        "squid": 12.985522953864312,
                        "salmon": 19.03879458392034
                    },
                    "timeOfDay": "day",
                    "inventoryUsed": 3,
                    "elapsedTime": 139
